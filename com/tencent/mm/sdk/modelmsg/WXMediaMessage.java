...
public final class WXMediaMessage
{
  ...
  public static class Builder
  {
    ...
    {
      Bundle localBundle;
      (localBundle = new Bundle()).putInt("_wxobject_sdkVer", paramWXMediaMessage.sdkVer);
    ...
    public static WXMediaMessage fromBundle(Bundle paramBundle)
    {
      ...
      (localWXMediaMessage = new WXMediaMessage()).sdkVer = paramBundle.getInt("_wxobject_sdkVer");
      ...
      String str;
      if (((str = pathOldToNew(paramBundle.getString("_wxobject_identifier_"))) == null) || (str.length() <= 0))
        return localWXMediaMessage;
      try
      {
        localObject = Class.forName(str);
        localWXMediaMessage.mediaObject = ((WXMediaMessage.IMediaObject)((Class)localObject).newInstance());
      ...
      catch (Exception localException)
      {
        ...
        a.a("MicroMsg.SDK.WXMediaMessage", "get media object from bundle failed: unknown ident " + str + ", ex = " + ((Exception)localObject).getMessage());
      }
      return localWXMediaMessage;
    }
